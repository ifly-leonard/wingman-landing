...
export default function AnimatedAccordionPage() {
    ...
    return (
      <section id="product-faq" className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        <SectionHeader header="Frequently Asked Questions" subheader="You're not the only one" />
